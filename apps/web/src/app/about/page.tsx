...
export const metadata: Metadata = {
  ...
  description:
    "Kawabunga is an immersive reality engine that opens the door to infinite worlds — reshaping how people learn, create, and experience life.",
};
        ...
        <div className="relative z-10 flex min-h-[75vh] flex-col justify-end px-6 pb-16 sm:px-10 lg:px-20">
          <div className="max-w-2xl space-y-5">
            ...
            <p className="max-w-lg text-[15px] leading-relaxed text-white/60">
              Kawabunga is an immersive reality engine that opens the door to
      ...
      <section className="bg-[#0a0a0a]">
        <div className="mx-auto w-full max-w-[720px] px-6 sm:px-10 lg:px-0">
          ...
          <div className="space-y-6 pt-[120px]">
            ...
            <div className="space-y-5 text-[17px] leading-[1.7] text-white/65">
              <p>
                Kawabunga began with a deceptively simple premise: what if technology could place you — fully, convincingly, consequentially — inside any world you could describe?
              </p>
              <p>
            ...
            <p className="text-[17px] leading-[1.7] text-white/65">
              That conviction — that the technology should vanish behind the world it creates — became the founding principle of Kawabunga. Every architectural decision, every model integration, every interface choice flows from it.
            </p>
          </div>
          ...
          <div className="mt-20 rounded-3xl border border-white/8 bg-white/[0.03] p-8 sm:p-10">
            ...
            <div className="mt-4 space-y-4 text-[15px] leading-[1.7] text-white/60">
              <p>
                At the core of Kawabunga is an immersive reality engine capable of generating, maintaining, and evolving entire worlds in real time. It holds persistent memory of characters, environments, and consequences. It adapts narratives to your decisions without breaking coherence.
              </p>
              <p>
        ...
        <div className="mx-auto mt-12 grid max-w-[1280px] gap-5 px-6 sm:px-10 md:grid-cols-3 lg:px-20">
          ...
          <div className="rounded-3xl border border-white/8 bg-white/[0.03] p-8">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/55">
              High-fidelity preparation turns practice into measurable performance. Surgeons rehearse before operating. Pilots train before flying. Kawabunga extends that same principle to communication, leadership, negotiation, and crisis response through realistic simulation loops that let users fail safely, adjust quickly, and improve with intent.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-white/55">
        ...
        <p className="mx-auto mt-10 max-w-[720px] px-6 text-center text-[15px] leading-[1.7] text-white/45 sm:px-10 lg:px-0">
          Two worlds. Two very different lives. But the same underlying revelation: the technology to make this real would change everything. Kawabunga is the proof.
        </p>
          ...
          <div className="overflow-hidden rounded-3xl border border-white/8 bg-white/[0.03]">
            <div className="relative aspect-[5/4] overflow-hidden">
              <Image
                ...
                alt="Binny Plotkin, Co-founder of Kawabunga"
                fill
                className="object-cover"
          ...
          <div className="overflow-hidden rounded-3xl border border-white/8 bg-white/[0.03]">
            <div className="relative aspect-[5/4] overflow-hidden">
              <Image
                ...
                alt="Josh Sassoon, Co-founder of Kawabunga"
                fill
                className="object-cover"
        ...
        <div className="mx-auto w-full max-w-[720px] px-6 sm:px-10 lg:px-0">
          ...
          <div className="space-y-6 pt-[120px]">
            ...
            <div className="space-y-5 text-[17px] leading-[1.7] text-white/65">
              ...
              <p>
                That changed. Large language models capable of holding entire worlds in memory, generating coherent consequence and dialogue, and adapting to user choices in real time have reached a threshold of maturity that makes Kawabunga not just possible — but inevitable.
              </p>
              <p>
                The appetite for this kind of experience is ancient and universal. The technology is finally here. Kawabunga exists at the precise intersection of the two — and the market it opens is as vast as the worlds it creates.
              </p>
            </div>
          </div>
          ...
          <div className="mt-[120px] rounded-3xl border border-white/8 bg-white/[0.03] p-10 text-center sm:p-14">
            ...
            <p className="mx-auto mt-5 max-w-md text-[15px] leading-relaxed text-white/45">
              Kawabunga is building the door. The worlds are waiting.
            </p>
